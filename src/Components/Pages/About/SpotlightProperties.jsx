  ...
  return (
    <>
      <div className='spotlight-properties px-4 md:px-6 lg:px-10 xl:px-20 py-20'>
        <div className="spotlight-title flex flex-col items-center justify-center section-title mb-10">
        <h4 className="text-[34px] md:text-5xl font-bold pb-5 text-center">
          Our Recommended Properties
        </h4>
        <p className="text-[#7a7a7a] font-normal text-center text-lg w-full lg:w-1/2 mx-auto ">
          Top Picks Backed by Trust
        </p>
      </div>
                    ...
                    {property.images.map((img, index) => (
                      <SwiperSlide key={index}>
                        <img
                          ...
                          className='img w-full object-cover rounded'
                        />
                      </SwiperSlide>
                    ))}
                  </Swiper>
