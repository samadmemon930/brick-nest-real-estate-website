    ...
    <>
      <div className='latest-properties px-4 md:px-6 lg:px-10 xl:px-20 py-20'>
        ...
        <div className="mt-20 flex justify-center">
          <Link
            to="/properties"
            className='text-[#6919dd] font-bold border-2 border-[#6919dd] px-5 py-2 rounded-md transition-all duration-300 hover:bg-[#6919dd] hover:text-white hover:shadow-md'
          >
            View All Properties
          </Link>
        </div>
